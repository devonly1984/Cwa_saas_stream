...
import { MeetingInsertSchema, MeetingUpdateSchema } from "@/lib/schemas/MeetingSchema";
...
export const meetingsRouter = createTRPCRouter({
  ...
  getMany: protecedProcedure
    ...
    create: protecedProcedure.input(MeetingInsertSchema).mutation(async({ctx,input})=>{
      ...
      return createdMeeting;
       ...
       update: protecedProcedure.input(MeetingUpdateSchema).mutation(async({ctx,input})=>{
